    ...
    function t(n) {
        function e(n, t, e, r) {
            ...
            return '<div class="page">\n                <div class="msg-box">\n                <div data-name="js-close" class="close-button"></div>\n                <header>' + n + '</header>\n                <div class="content-area">\n                    ' + t + "\n                    " + e + '\n                </div>\n                <div class="action-area">\n                    <div class="button-strip"> ' + r.map(function(n, t) {
                return '<button class="btn btn-default" tabindex=' + t + ' data-name="js-' + n.toLowerCase() + '">' + n + "</button>"
            }).join("") + "\n                    </div>\n                </div>\n                </div>\n            </div>"
        }
        ...
        function r(n, t, r, o, u) {
            var c = document.createElement("div"),
                ...
                m = e(n, t, r, o);
            return c.innerHTML = m, c.className = "smalltalk", document.body.appendChild(c), s(c, ["ok", "input"]).forEach(function(n) {
                return n.focus()
            }), s(c, ["input"]).forEach(function(n) {
                n.setSelectionRange(0, r.length)
            }), l("click", c, f, function(n) {
                return i(n.target, c, d, v)
            }), ["click", "contextmenu"].forEach(function(n) {
                return c.addEventListener(n, function() {
                    return s(c, ["ok", "input"]).forEach(function(n) {
                        return n.focus()
                    })
                })
        ...
        function a(n, t, e) {
            return function(r) {
                var a = {
                    ...
                    f = r.target,
                    d = ["ok", "cancel", "input"],
                    p = s(n, d).map(function(n) {
                        return o(n)
                    });
                switch (l) {
                    case a.ENTER:
                        i(f, n, t, e), r.preventDefault();
                        break;
                    case a.ESC:
                        v(), e();
                        break;
        ...
        function u(n, t) {
            var e = "",
                ...
                u = /ok|cancel/.test(a),
                c = t.length - 1;
            "input" !== a && c && u && (e = "cancel" === a ? "ok" : "cancel", s(n, [e]).forEach(function(n) {
                return n.focus()
            }))
        }
        ...
        function i(n, t, e, r) {
            ...
            /close|cancel/.test(o) ? r() : (a = s(t, ["input"]).reduce(function(n, t) {
                return t.value
            }, null), e(a)), v()
        }
        ...
        this.alert = function(n, t, e) {
            return r(n, t, "", p, e)
        }, this.prompt = function(n, t, e, a, o) {
            var u = e || "",
                c = o || "",
                i = '<input type="text" value="' + u + '" data-name="js-input" placeholder="' + c + '">';
            return r(n, t, i, m, a)
